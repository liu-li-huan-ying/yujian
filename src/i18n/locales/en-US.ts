...
const enUS = {
  ...
  ui: {
    ...
    exportMenuLatex: 'LaTeX source',
    exportMenuSelection: 'Export selection only',
    exportOptToc: 'Table of contents',
    exportOptCover: 'Cover page',
    exportOptInline: 'Inline images (self-contained)',
    exportOptPreview: 'Preview before export',
    ...
    compileBookTitle: 'Book title',
    compileBookTitlePlaceholder: 'Leave blank to use vault name',
    compileNewPage: 'Each note on a new page',
    compileFormat: 'Output format',
    compileSelected: '{n} selected',
    compileSelectAll: 'Select all',
    compileClear: 'Clear',
    compileUp: 'Move up',
    compileDown: 'Move down',
    compileCancel: 'Cancel',
