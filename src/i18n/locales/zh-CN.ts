...
const zhCN = {
  ...
  ui: {
    ...
    cjkTitle: '中文排版',
    cjkEnabled: '中文排版优化',
    cjkEnabledDesc: '中英间距、标点、强调按中文规范呈现；仅影响显示，不改动源文件',
    cjkSpace: '中英 / 中数间距',
    cjkSpaceDesc: '汉字与拉丁字母、数字之间自动补 ¼ em 视觉间隙',
    cjkEmphasis: '中文强调',
    cjkEmphasisDesc: '强调改用强调色，不再用斜体（英文斜体亦一并变色，可关闭）',
    cjkPunct: '标点挤压与避头尾',
    cjkPunctDesc: '连续全角标点收紧，行首行尾标点不再突兀',
    cjkGap: '中文段落间距',
    cjkGapDesc: '段落间距略增 4px，补偿全角标点的视觉密度',
    /* ── 快捷键设置（批次四）── */
    shortcuts: '快捷键',
    scClose: '×',
    scSearch: '搜索命令…',
    scEmpty: '没有匹配的命令',
    scIntro: '点右侧键位胶囊后按下新组合即可改键；分组与命令面板一致。',
    scNone: '未绑定',
    scCustom: '已改',
    scReset: '重置',
    scResetAll: '全部恢复默认',
    scResetAllAsk: '确定全部恢复默认？',
    scResetAllYes: '恢复',
    scRecord: '按下新键位…',
    scRecordHint: 'Esc 取消 · Delete 清除绑定',
    scConflict: '已被「{name}」占用',
    scReplace: '替换',
    scCancel: '取消',
    scNoModifier: '至少要带 Ctrl 或 Alt（F1~F12 可单独使用）',
    scReservedApp: '固定入口「{name}」，不可分配给其它命令',
    scReservedSystem: '系统 / 浏览器保留，无法可靠拦截',
    scReservedEditor: '编辑器正文正在使用，占用后正文里该键会失效',
    scFixedTitle: '固定键位',
    scFixedHint: '这两个键位负责「打开设置本身」，若允许改掉，一旦被占就再也进不来了，故固定不可改。',
    newDoc: '新建文档',
    saveAs: '另存为',
    about: '关于',
    more: '更多',
    ...
    mocClose: '关闭',
    mocLoading: '正在聚合…',
    mocEmpty: '这张内容地图还没有可聚合的下级 —— 给它加标签，或在正文写 [[链接]]',
    mocNotMocHint: '当前笔记还不是内容地图。点击下方「标记为内容地图」，即可把本篇变成按标签与双链自动聚合的主题入口。',
    mocMark: '标记为内容地图',
    mocUnmark: '取消内容地图标记',
    mocMarked: '已将本篇标记为内容地图',
    mocUnmarked: '已取消内容地图标记',
    mocListTitle: '库内的内容地图',
    mocListEmpty: '库内还没有内容地图',
    /* ── 关系图谱（批次三之三）── */
    graph: '关系图谱',
    graphLocal: '本地子图',
    graphGlobal: '全局',
    ...
    graphCanvasView: '图谱',
    graphListView: '列表',
    graphNodeCount: '{n} 个笔记',
    graphTruncated: '已显示 {shown} / 共 {total}，切换本地子图以聚焦',
    graphEmpty: '当前库内还没有笔记间的双链关系',
    graphHint: '单击选中 · 双击打开 · 拖拽平移 · 滚轮缩放',
    graphListTitle: '关系图谱 · 列表视图',
    mocRebuild: '重建索引',
    mocRebuilding: '正在重建索引…',
    mocRebuilt: '索引已重建',
    mocGroupOutlinks: '本图链出',
    mocGroupBacklinks: '挂到本图',
    mocTruncated: '条目过多，仅显示前 200 条',
    tagsRebuild: '重建索引',
    tagsRebuilding: '正在重建索引…',
    tagsRebuilt: '索引已重建',
    /* ── 完整性自检（批次一：数据安全）── */
    integrity: '完整性自检',
    integrityRerun: '重新扫描',
    ...
    writingAids: {
      ...
      labelDate: '日期',
      labelMoc: '设为内容地图',
      mocHint: '勾选后，本篇将作为按标签与双链自动聚合的主题入口',
      placeTitle: '文档标题',
      placeAuthor: '作者名',
      placeDesc: '一句话简介',
      placeTags: '标签1, 标签2',
  ...
  /* ── 帮助面板：使用指南与关于（键位清单已并入「快捷键设置」，避免两处键位表不一致） ── */
  help: {
    close: '×',
    aboutTitle: '关于 玉笺',
    aboutVersion: '版本',
    guideTitle: '快速上手 玉笺',
    guideIntro:
      '玉笺是一款为技术写作者打造的桌面 Markdown 编辑器：所见即所得与源码双模式、多标签、版本快照与凝神沉浸写作，本地优先、Markdown 往返保真。2.0 新增命令面板与完整的个人知识管理（双向链接 · 标签 · 内容地图 · 关系图谱），玉质美学界面。',
    guideSections: [
      {
        h: '1 · 打开笔记库',
      ...
      {
        h: '9 · 命令面板',
        p: '按 Ctrl+Shift+P 打开命令面板，键盘检索并执行任意命令（打开笔记库、切换大纲 / 图谱、进入凝神、导出、切换皮肤……）；按 Ctrl+K 直接搜索并跳转到某篇笔记。面板增多后的统一入口，也可用活动栏按钮触发。',
      },
      {
        h: '10 · 双向链接 · 标签 · 内容地图 · 关系图谱',
        p: '玉笺 2.0 内置个人知识管理：用 [[笔记名]] 写双向链接，悬停工具条或标题栏「更多」可插入，右侧「反链」面板列出谁链接了当前笔记；#标签 内联标记，左侧「标签」面板聚合全库标签；用 frontmatter 的 moc 标记生成内容地图；点击活动栏第 7 个按钮进入全屏关系图谱，按节点关系浏览与导航你的知识网络。重命名或移动笔记时，[[引用]] 会自动改写。',
      },
    ],
    aboutBody:
  ...
  palette: {
    ...
    cmd: {
      ...
      'knowledge.tags': '标签面板',
      'knowledge.moc': '内容地图',
      'knowledge.backlinks': '反链面板',
      'knowledge.snapshot': '快照面板',
      'knowledge.insertWikiLink': '插入双链',
      'tool.linkCheck': '链接检查',
      'tool.integrity': '完整性自检',
      'tool.backup': '备份与恢复',
      'tool.writingAids': '写作辅助',
      'tool.imgHost': '图床设置',
      ...
      'export.compile': '多文件合订',
      'export.publishImages': '上传图片到图床',
      'settings.appearance': '外观与皮肤',
      'settings.preferences': '偏好设置',
      'settings.shortcuts': '快捷键',
      'settings.guide': '使用指南',
      'settings.toggleLocale': '切换界面语言',
    },
  },
}
